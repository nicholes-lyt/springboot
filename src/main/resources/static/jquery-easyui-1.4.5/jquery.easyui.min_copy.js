...
//update
var _322=$("<div id=\"custom-tabs-tool\" class=\"tabs-tool\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>").appendTo(_321);
var tr=_322.find("tr");
...
//update
$("<div class=\"tabs-header\">"+"<div class=\"tabs-scroller-left\"></div>"+"<div class=\"tabs-scroller-right\"></div>"+"<div id=\"custom-tabs-wrap\" class=\"tabs-wrap\">"+"<ul class=\"tabs\"></ul>"+"</div>"+"</div>").prependTo(_336);
...
{  
    ...
    handler : function(_abe) {  
        $(_abe).combo("setValue", "").combo("setText", ""); // 设置空值  
        $(_abe).combo("hidePanel"); // 点击清空按钮之后关闭日期选择面板  
    }  
}, 
